...
public class ToRpeDo {
    ...
    public static void main(String[] args) {
        ...
        for (int playerIndex = 0; playerIndex < playersCount; playerIndex++) {
            ...
            // AI hajók elhelyezése automatikusan, ha 1 játékos és ez az AI játékosa (playerIndex == 1)
            ...
            while (totalShips > 0) {
                ...
                // Kezdő koordináták rendezése, hogy balról jobbra / fentről lefelé haladjunk
    ...
    private static void playAgainstAI(Scanner scanner, char[][] playerMap, List<Ship> playerShips,
        ...
        while (true) {
            if (turn == 0) {
                ...
                printMap(mapsGrids.get(0), playerShips, 0); //  Mutassa az AI által célzott térképet
    ...
    private static boolean isValidPosition(char[][] map, List<Ship> existingShips,
        ...
        // Ellenőrizzük a túl közeli elhelyezést
    ...
    private static void markSurroundings(char[][] map, Ship ship) {
        ...
        // Nézzük végig a hajó összes mezőjét
    ...
    private static void printMapMask(char[][] map) {  //aimap
        ...
        for (int row = 0; row < MAP_SIZE; row++) {
            ...
            for (int col = 0; col < MAP_SIZE; col++) {
                char c = map[row][col];
                if (c == 'X') {
                    System.out.print("\u001B[32mX\u001B[0m  ");  // zöld
                } else if (c == 'O') {
                    System.out.print("\u001B[33mO\u001B[0m  ");  // sárga
                } else {
                    System.out.print("\u25A1  ");
                }
            }
